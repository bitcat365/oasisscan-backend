...
public class ScanRuntimeTransactionService {
    ...
    public void scanTransaction() throws Exception {
        ...
        for (String runtimeId : runtimes) {
            ...
            log.info("runtime transaction sync start {} {} {}", runtimeId, scanRound, currentRound);
...
//                }
                    ...
                    log.info(String.format("runtime transaction %s, round: %s, count: %s", runtimeId, scanRound, 0));
                    continue;
                }
...
//            }
                ...
                log.info(String.format("runtime transaction %s, round: %s, count: %s", runtimeId, scanRound, list.size()));
            }
        }
    }
